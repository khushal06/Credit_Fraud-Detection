...
2. Trains two models and compares them
...
| Model | Precision | Recall | F1 | PR-AUC | Fraud caught / missed | False alarms |
|-------|-----------|--------|----|--------|----------------------|--------------|
| Logistic Regression | 0.061 | 0.918 | 0.114 | 0.716 | 90 / 8 | **1,386** |
| **XGBoost** | **0.872** | 0.837 | **0.854** | **0.873** | 82 / 16 | **12** |
...
- **XGBoost** caught a bit less fraud (83.7%) but with only **12 false alarms** instead of 1,386. That's a massively better balance.
...
python src/train.py      # train both models + save results
